...
public class Main {
	public static void main(String[] args){
		...
		ClientePF cli1 = new ClientePF("Roberto Justus Segundo", "Rua Ben10", carrosCli1, "masculino", "classe alta", 
										"superior", LocalDate.now(), "018.691.799-60", "06/08/2000" ); // Builder PF
		...
		ClientePJ cli2 = new ClientePJ("Mac Donalds", "Rua Batatinha", carrosCli2, "42.591.651/0001-43", "15/04/1995" ); // Builder
		...
		do {
			...
			case("Cadastrar ClientePJ"):
				...
				ClientePJ cliTeste2 = new ClientePJ(nomeTeste2, endeTeste2, autoTeste2, cnpjTeste, fundTeste);
